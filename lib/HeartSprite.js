HeartSprite = function(position, clickBehavior) {
    ...
    this.init = function() {
        ...
        this.sprite.scale = new THREE.Vector2(2.0, 2.0);
    ...
    this.update = function(delta) {
        ...
        this.sprite.position.y += (driftSpeed * Math.sin(time/2));
        this.sprite.position.z += driftSpeed/10;

        if (this.sprite.position.z > camera.position.z) {
            this.ResetSprite();
        }
